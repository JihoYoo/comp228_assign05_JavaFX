	...
	public static void displayAllRows(GridPane tableData, String table) throws SQLException
	{
				...
				ResultSet resultSet = statement.executeQuery(SQLQuery);)
		{
			...
			{				
				...
				tableData.add(new Label("ID: " +id + " " + "Game ID: " + gameId + " " + "Player ID: " + playerId + " " + "DATE: " + formattedDate + " " + "Score: " + score), 0, id-1);
	...
	public static void displayAllRows2(GridPane tableData, String table) throws SQLException
	{
				...
				ResultSet resultSet = statement.executeQuery(SQLQuery);)
		{
			...
			{				
				...
				tableData.add( new Label("Player" + firstName + " Game Title: " + gameTitle + " Date: " + formattedDate + " Score: " + score), 0 , id-1);				
			}
		}
		catch(SQLException exception)
		{
